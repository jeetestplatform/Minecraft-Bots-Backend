...
function setupBotHandlers() {
  ...
  bot.on('chat', (username, message) => {
    ...
    if (username === '.Vikram8515' && normalizedMessage === 'teleport me to goldfarm') {
    ...
    else if (normalizedMessage === 'teleport me to goldfarm') {
    ...
    // Add specific support for .Vikram8515 with another command
    ...
    } else if (normalizedMessage === 'goldfarmbot teleport here' || normalizedMessage === 'goldfarmbot teleport here') {
      ...
      console.log(`No match. Expected commands: "hey homebot, tp me", "nehterbot teleport here", "teleport me to goldfarm", or "hey homebot, tp vikram". Got: "${normalizedMessage}"`);
    }
  })
